    ...
    for (int i = 0; i < 8; ++i) {
        ...
        for (int j = 0; j < 8; ++j) {
            ...
            if (board->squares[i][j] != NULL) {
                ...
                case KING:
                    if (board->squares[i][j]->color == WHITE) printf("| wk ");
                    else printf("| bk ");
                    break;
                case QUEEN:
                    if (board->squares[i][j]->color == WHITE) printf("| wq ");
                    else printf("| bq ");
                    break;
                case ROOK:
                    if (board->squares[i][j]->color == WHITE) printf("| wr ");
                    else printf("| br ");
                    break;
                case BISHOP:
                    if (board->squares[i][j]->color == WHITE) printf("| wb ");
                    else printf("| bb ");
                    break;
                case KNIGHT:
                    if (board->squares[i][j]->color == WHITE) printf("| wn ");
                    else printf("| bn ");
                    break;
                case PAWN:
                    if (board->squares[i][j]->color == WHITE) printf("| wp ");
                    else printf("| bp ");
                    break;
                }
            }
